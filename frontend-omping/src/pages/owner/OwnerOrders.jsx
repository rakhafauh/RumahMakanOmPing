/**
 * OwnerOrders - Halaman kelola pesanan untuk Owner
 * Terima/Tolak pesanan, lihat status, cetak struk
 * Dibuat semirip mungkin dengan KasirOrders
 */
  ...
  return (
    <DashboardLayout role="owner">
      <div className="dashboard-header">
        <h1>
          <Package size={24} /> Kelola Pesanan
        </h1>
      </div>
      ...
      >
        {receiptOrder && (
          <div>
            {/* Receipt content — styled identically to Kasir */}
